...
- использование JavaScript библиотек и фреймворков не допускается
- использование CSS фреймворков не допускается  
- использование CSS препроцессоров не допускается
...
### Будет плюсом если:
- будут использованы в коде фишки стандарта ES6 и выше (classes, деструктуризация и т.д.) без использования полифиллов
